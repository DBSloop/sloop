...
export class Postgres {
  ...
  protected readonly reset = computed<readonly TerminalLine[]>(() => [
    ...
    { kind: 'warn', tag: '  Gone', text: ` ${this.path('server.toml')}` },
    { kind: 'warn', tag: '  Gone', text: ` ${this.path('registry.toml')}` },
    { kind: 'warn', tag: '  Gone', text: ` ${this.path('projects')}` },
    { kind: 'warn', tag: '  Gone', text: ` ${this.path('locks')}` },
    { kind: 'warn', tag: '  Gone', text: ` ${this.path('postgres')}` },
    { text: ' ' },
